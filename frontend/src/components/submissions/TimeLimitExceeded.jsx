...
const TimeLimitExceeded = ({ result, id }) => {
    ...
    return (
        <div className="result-container">
            ...
            <div className="status-header">
                <h2 className="status-text" style={{ color: 'var(--warning-color)' }}>⏱️ Time Limit Exceeded</h2>
                <p className="testcase-info">Execution time exceeded the allowed limit</p>
            </div>

            {/* Middle Timeout Info Section */}
            <div className="testcase-box">
                <h3>Timeout Details</h3>
